        ...
        <div class="social-media mb-5">
          <ul class="flex">
            ...
            <li class="hover:text-gray-700 pr-4 flex">
              ...
              <span class="px-4">{{$post->ratings->average('stars_rated') ?? '0'}}</span>
            </li>
